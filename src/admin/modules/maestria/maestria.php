<?php
// src/admin/modules/maestria/programa.php
    ...
    <div class="programas-container">
        ...
        <div class="page-header">
            <div class="header-title">
                ...
                <p>Gestión de programas de maestría (2 años de duración)</p>
            </div>
            <a href="agregar.php?tipo=maestria" class="btn-nuevo">
                <i class="fas fa-plus-circle"></i> Nueva Maestría
            </a>
        </div>
        ...
        <div class="programas-grid">
            ...
            <?php else: ?>
                <div class="empty-state">
                    <i class="fas fa-graduation-cap"></i>
                    <h3>No hay maestrías registradas</h3>
                    <p>Comienza agregando tu primera maestría</p>
                    <a href="agregar.php?tipo=maestria" class="btn">
                        <i class="fas fa-plus-circle"></i> Agregar Maestría
                    </a>
                </div>
            <?php endif; ?>
        </div>
...
function confirmarEliminacion(id, nombre) {
    if (confirm('¿Estás seguro de eliminar la maestría "' + nombre + '"? Esta acción no se puede deshacer.')) {
        window.location.href = 'eliminar.php?id=' + encodeURIComponent(id) + '&tipo=maestria';
    }
}
</script>
